...
def update_combined(folderPath, filePath, apiKey, dataType="csv"):
	...
	if universe == "SNP500" or universe == "DOW30": 
		...
		universeList = ticker_universe.obtain_parse_mutual_funds()
	elif universe == "ETF100":
		universeList = ticker_universe.obtain_parse_etfs()
	# Gets the function (daily, intradaily, etc.) from the file name
	# Now gets the adjusted ones properly
	function = "_".join(nameSplit[2:])
	interval = ""
	if "&" in function:
